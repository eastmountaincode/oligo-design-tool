...
export default function OligoDesignerPage({ liveDna }: OligoDesignerPageProps) {
  ...
  }, [oligoLength, overlapLength, upstream, downstream, mvConc, dvConc, dntpConc, dnaConc, annealingTemp]);

  // Auto-run design when liveDna changes (debounced)
  useEffect(() => {
    if (!liveDna) return;
    setSequence(liveDna);
